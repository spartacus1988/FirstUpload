...
//    return;
$ABS_FILE_NAME_PROTOTYPES = $_SERVER["DOCUMENT_ROOT"] . '/bitrix/components/es/FirstUpload/prototypes_work.xml';
$ABS_FILE_NAME_PROTOTYPES_ALL = $_SERVER["DOCUMENT_ROOT"] . '/bitrix/components/es/FirstUpload/prototypes_0.xml';
$ABS_FILE_NAME_PROTOTYPES_TEST = $_SERVER["DOCUMENT_ROOT"] . '/bitrix/components/es/FirstUpload/prototypes_work_test.xml';
$ABS_FILE_NAME_PROTOTYPES_TEMP = $_SERVER["DOCUMENT_ROOT"] . '/bitrix/components/es/FirstUpload/prototypes_work_temp.xml';
$ABS_FILE_NAME_OFFERS = $_SERVER["DOCUMENT_ROOT"] . '/bitrix/components/es/FirstUpload/offers_work.xml';
$ABS_FILE_NAME_OFFERS_ALL = $_SERVER["DOCUMENT_ROOT"] . '/bitrix/components/es/FirstUpload/offers_0.xml';
$ABS_FILE_NAME_OFFERS_TEST = $_SERVER["DOCUMENT_ROOT"] . '/bitrix/components/es/FirstUpload/offers_work_test.xml';
$ABS_FILE_NAME_OFFERS_TEMP = $_SERVER["DOCUMENT_ROOT"] . '/bitrix/components/es/FirstUpload/offers_work_temp.xml';
$ABS_FILE_NAME_PATTERN = $_SERVER["DOCUMENT_ROOT"] . '/bitrix/components/es/FirstUpload/pattern_work.xml';
$ABS_FILE_NAME_UPLOAD = $_SERVER["DOCUMENT_ROOT"] . '/bitrix/components/es/FirstUpload/upload_work.xml';
$ABS_FILE_NAME_AUTH = $_SERVER["DOCUMENT_ROOT"] . '/bitrix/components/es/FirstUpload/AUTH.txt';
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
$ABS_FILE_NAME_PRICES = $_SERVER["DOCUMENT_ROOT"] . '/bitrix/components/es/FirstUpload/prices_work.xml';
$ABS_FILE_NAME_PRICES_TEMP = $_SERVER["DOCUMENT_ROOT"] . '/bitrix/components/es/FirstUpload/prices_work_temp.xml';
$ABS_FILE_NAME_INSTOCK = $_SERVER["DOCUMENT_ROOT"] . '/bitrix/components/es/FirstUpload/instock_work.xml';
$ABS_FILE_NAME_INSTOCK_TEMP = $_SERVER["DOCUMENT_ROOT"] . '/bitrix/components/es/FirstUpload/instock_work_temp.xml';
$WORK_DIR_UPLOAD = $_SERVER["DOCUMENT_ROOT"] . '/upload/';
$WORK_DIR_UPLOAD_CATALOG = $_SERVER["DOCUMENT_ROOT"] . '/upload/upload/catalog/';
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
$ABS_FILE_NAME_COMPATIBILITY_ALL = $_SERVER["DOCUMENT_ROOT"] . '/bitrix/components/es/FirstUpload/compatibility_0.xml';
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
define("LOG_FILENAME", $_SERVER["DOCUMENT_ROOT"] . '/bitrix/components/es/FirstUpload/FirstUploadLOG.txt');
$ABS_LOG_FILENAME = $_SERVER["DOCUMENT_ROOT"] . '/bitrix/components/es/FirstUpload/FirstUploadLOG.txt';
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
if (file_exists($ABS_FILE_NAME_PROTOTYPES))
{
    ...
    {
        AddMessage2Log("CRAFTMIDDLE_IS_DEAD ", "FirstUpload");
                ...
                foreach ($xml_upload->xpath('//Классификатор/Группы/Группа') as $producers_items)
                {
                    ...
                    if ($producers_items_name[0] == $producer_var[0])
                    {
                        ...
                        if ($group_node_elems[$count_group_node_elems - 1] !== NULL)
                        {
                            ...
                            $group_node_elems[$count_group_node_elems - 1]->ЗначенияСвойств->ЗначенияСвойства[5]->addChild('Значение', $uf_model);
    ...
    foreach ($xml_offers->xpath('//dataWs') as $item_offers)
    {
        ...
        if ($xml_upload->xpath('//ПакетПредложений/Предложения'))
        {
            ...
            if ($offer_node[$count_offers_node - 1] !== NULL)
            {
                ...
                $offer_node[$count_offers_node]->ЗначенияСвойств->ЗначенияСвойства[2]->addChild('Значение', '500');
                ...
                $offer_node[$count_offers_node]->ЗначенияСвойств->ЗначенияСвойства[6]->addChild('Значение', '');
                ...
                $offer_node[$count_offers_node]->ЗначенияСвойств->ЗначенияСвойства[9]->addChild('Значение', $originalCode_var[0]);
                $offer_node[$count_offers_node]->ЗначенияСвойств->ЗначенияСвойства[9]->addChild('ЗначенияСвойства', '');
                $offer_node[$count_offers_node]->ЗначенияСвойств->ЗначенияСвойства[9]->ЗначенияСвойства[0]->addChild('Значение', $originalCode_var[0]);
                ...
                $offer_node[$count_offers_node]->ЗначенияСвойств->ЗначенияСвойства[15]->addChild('Значение', 'Сертификация на территории РФ: AE63, МЕ06');
                $offer_node[$count_offers_node]->ЗначенияСвойств->ЗначенияСвойства[15]->addChild('ЗначенияСвойства', '');
                $offer_node[$count_offers_node]->ЗначенияСвойств->ЗначенияСвойства[15]->ЗначенияСвойства[0]->addChild('Значение', 'Сертификация на территории РФ: AE63, МЕ06');
                ...
                $offer_node[$count_offers_node]->ЗначенияСвойств->ЗначенияСвойства[16]->addChild('Значение', '12 месяцев');
                $offer_node[$count_offers_node]->ЗначенияСвойств->ЗначенияСвойства[16]->addChild('ЗначенияСвойства', '');
                $offer_node[$count_offers_node]->ЗначенияСвойств->ЗначенияСвойства[16]->ЗначенияСвойства[0]->addChild('Значение', '12 месяцев');
...
} else
{
    ...
    if ($xml_instock->xpath('//dataWs'))
    {
        foreach ($xml_instock->xpath('//dataWs') as $item_instock)
        {
            ...
            $res = CIBlockElement::GetList(array(), array("IBLOCK_ID" => $GLOBAL_IBLOCK_ID));
...
if ($xml_upload->xpath('//Классификатор/Группы/Группа/Группы/Группа'))
{
    ...
    foreach ($xml_upload->xpath('//Классификатор/Группы/Группа/Группы/Группа') as $proto_items)
    {
         ...
         */
        $path_telpic = GetCurlTelPIC($temp_proto_items_article[0], '' . $temp_proto_items_article[0], $LOGIN, $PWS, $WORK_DIR_NAME . 'telpic');
        ...
        if ($THERE_IS_FIRST_UPLOAD == FALSE)
        {
            ...
            while ($arSection = $rsSections->Fetch())
            {
                ...
                if (trim($str_one) == trim($str_two))
                {
                    ...
                    AddMessage2Log("В разделе с ID = " . $arSection['ID'] . " добавление  картиники с ID = " . $fid, "PictureUpload");
                }
            }
        }
        /**
...
if ($xml_upload->xpath('//ПакетПредложений/Предложения/Предложение'))
{
    ...
    foreach ($xml_upload->xpath('//ПакетПредложений/Предложения/Предложение') as $offer_items)
    {
        ...
        if ($THERE_IS_FIRST_UPLOAD == FALSE)
        {
            $res_del_Elements = CIBlockElement::GetList(array(), array("IBLOCK_ID" => $GLOBAL_IBLOCK_ID), false);
       ...
       else
       {
            ...
            */
           $path_acupic_1 = GetCurlAcuPIC($temp_offer_items_article[0], '' . $temp_offer_items_article[0], $LOGIN, $PWS, $WORK_DIR_NAME . 'acupic/', '1');
           $path_acupic_2 = GetCurlAcuPIC($temp_offer_items_article[0], '' . $temp_offer_items_article[0], $LOGIN, $PWS, $WORK_DIR_NAME . 'acupic/', '2');
           $path_acupic_3 = GetCurlAcuPIC($temp_offer_items_article[0], '' . $temp_offer_items_article[0], $LOGIN, $PWS, $WORK_DIR_NAME . 'acupic/', '3');
           $path_acupic_4 = GetCurlAcuPIC($temp_offer_items_article[0], '' . $temp_offer_items_article[0], $LOGIN, $PWS, $WORK_DIR_NAME . 'acupic/', '4');
           ...
           if ($THERE_IS_FIRST_UPLOAD == FALSE)
           {
               $res_Elements = CIBlockElement::GetList(array(), array("IBLOCK_ID" => $GLOBAL_IBLOCK_ID), false);
...
{
    AddMessage2Log("загрузка на сайт НЕ ПРОИЗВОДИЛАСЬ", "FirstUpload");
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////end of 
